    ...
    <body class="body-especial">
        ...
        <main class="main-especial">
            <div class="formulario-crear">
                ...
                <form method="post" action="{{ url('Crud/Resultados_Grupo/'.$resultado->id) }}">
                    @csrf
                    {{ method_field('PATCH') }}
                    ...
                    <input type="text" id="grupo" name="Grupo" value="{{ isset($resultado->Grupo)?$resultado->Grupo:old('Grupo') }}">
                    ...
                    <select id="clasificacion" name="Clasificacion">
                        ...
                        <option value="Avanza Ronda" {{ ($resultado->Clasificacion == 'Avanza Ronda')?'selected':'' }}>Avanza Ronda</option>
                    </select>
