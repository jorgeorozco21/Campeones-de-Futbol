    ...
    <body class="body-especial">
        <main class="main-especial">
            <div class="funciones">
                ...
                <a href="{{ url('Crud/Resultados_Grupo/create') }}" class="boton agregar">+ Agregar</a>
            ...
            <table class="informacion">
                <tr>
                    ...
                    <th class="columna principal">Grupo</th>
                ...
                @foreach ($resultadosGrupos as $resultado)
                    <tr>
                        ...
                        <td class="columna"><img src="{{ asset('storage').'/'.$resultado->Logo }}" class="escudo">{{ $resultado->nombreCompeticion }} {{ $resultado->Edicion }}</td>
                        <td class="columna">{{ $resultado->Grupo }}</td>
                        ...
                        <td class="columna editar-eliminar">
                            <a href="{{ url('Crud/Resultados_Grupo/'.$resultado->id.'/edit') }}" class="boton editar">Editar</a> 
                            <form  action="{{ url('Crud/Resultados_Grupo/'.$resultado->id) }}" method="post">
                                @csrf
                                {{ method_field('DELETE') }}
