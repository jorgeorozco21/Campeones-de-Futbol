    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-3 flex flex-col gap-6">
            ...
            <div class="flex flex-col items-center">
                <h2 class="text-3xl text-white font-bold">Premier League</h2>
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 md:gap-10">
                ...
                <p class="w-[95%] text-white text-sm md:text-base leading-relaxed text-center md:text-left">
                    ...
                    <br><br>
                    La Premier League es conocida por su alto nivel competitivo, estadios llenos y gran intensidad de juego.
                </p>
            </div>
